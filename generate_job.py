...
source /lustre03/project/6019267/shared/tools/PIPELINES/ShortReads/bin/activate
#
### Launch script
#
# newgrp rrg-tetreaum
#
python -u /lustre03/project/6019267/shared/tools/PIPELINES/ShortReads/ShortReadSequencing/pipeline_short.py --sample {6} --config {7}
#
""".format(
